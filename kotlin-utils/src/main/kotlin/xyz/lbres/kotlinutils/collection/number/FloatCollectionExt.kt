 ...
 *
 * @return [List]<Float>: list containing the same values as this collection, except any elements with value 0.
 */
fun Collection<Float>.filterNotZero(): List<Float> = filterNot { it.isZero() }
