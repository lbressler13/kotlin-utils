 ...
 *
 * @return [Collection]<Double>: collection containing the same values as this collection, except any elements with value 0.
 */
fun Collection<Double>.filterNotZero(): Collection<Double> = filterNot { it.isZero() }
