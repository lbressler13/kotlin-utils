 ...
 *
 * @return [Collection]<Short>: collection containing the same values as this collection, except any elements with value 0.
 */
fun Collection<Short>.filterNotZero(): Collection<Short> = filterNot { it.isZero() }
