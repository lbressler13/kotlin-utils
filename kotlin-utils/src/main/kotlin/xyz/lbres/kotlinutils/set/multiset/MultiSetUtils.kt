 ...
 * @return [MultiSet]<E>
 */
fun <E> constMultiSetOf(vararg elements: E): MultiSet<E> = ConstMultiSet(elements.toList())
 ...
 * @return [MutableMultiSet]<E>
 */
fun <E> constMutableMultiSetOf(vararg elements: E): MutableMultiSet<E> = MutableConstMultiSet(elements.toList())
