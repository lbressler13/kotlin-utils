...
internal class MultiSetImpl<E> : PartialMultiSetImpl<E> {
    /**
 ...
 */
internal sealed class PartialMultiSetImpl<E> : MultiSet<E> {
    /**
    ...
    private fun genericBinaryOperation(other: MultiSet<E>, operation: (count: Int, otherCount: Int) -> Int, useAllValues: Boolean = true): MultiSet<E> {
        ...
        val newCounts: Map<E, Int> = if (other is MultiSetImpl<E>) {
