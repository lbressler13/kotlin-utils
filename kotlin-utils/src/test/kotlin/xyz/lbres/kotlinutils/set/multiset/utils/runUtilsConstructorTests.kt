...
internal fun runMultiSetOfTests() {
...
internal fun runMutableMultiSetOfTests() {
...
internal fun runEmptyMultiSetTests() {
    val set = emptyMultiSet<Int>()
    val expected = multiSetOf<Int>()
    assertEquals(expected, set)
}

internal fun runMultiSetTests() {
...
internal fun runMutableMultiSetTests() {
