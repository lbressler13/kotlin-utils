...
fun runPlusCTests(createSet: (Collection<*>) -> ConstMultiSet<*>, createOtherSet: (Collection<*>) -> ConstMultiSet<*>) {
    ...
    assertEquals(intExpected, intSet1 `+c` intSet2)
    assertIs<ConstMultiSet<Int>>(intSet1 `+c` intSet2)
    ...
    assertEquals(intExpected, intSet2 `+c` otherSet)
    assertIs<ConstMultiSet<Int>>(intSet2 `+c` otherSet)
    ...
    assertEquals(stringExpected, stringSet1 `+c` stringSet2)
    assertEquals(stringExpected, stringSet2 `+c` stringSet1)
...
fun runIntersectCTests(createSet: (Collection<*>) -> ConstMultiSet<*>, createOtherSet: (Collection<*>) -> ConstMultiSet<*>) {
    ...
    assertIs<ConstMultiSet<Int>>(intSet1 intersectC intSet2)
    ...
    assertIs<ConstMultiSet<IntList>>(intSet1 intersectC intSet2)
    ...
    assertIs<ConstMultiSet<Exception>>(intSet1 intersectC intSet2)
}
