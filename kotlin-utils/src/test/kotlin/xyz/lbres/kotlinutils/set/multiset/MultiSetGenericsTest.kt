...
class MultiSetGenericsTest {
    ...
    fun testGenericPlus() {
        ...
        assertEquals(expectedInt, genericPlus(intSet1, intSet2))
        assertEquals(expectedInt, genericPlus(intSet2, intSet1))
        ...
        assertEquals(expectedString, genericPlus(stringSet1, stringSet2))
        assertEquals(expectedString, genericPlus(stringSet2, stringSet1))
        ...
        assertEquals(expectedList, genericPlus(listSet1, listSet2))
        assertEquals(expectedList, genericPlus(listSet2, listSet1))
        ...
        assertEquals(expectedCompList, genericPlus(compListSet1, compListSet2))
        assertEquals(expectedCompList, genericPlus(compListSet2, compListSet1))
        ...
        assertEquals(expectedNull, genericPlus(nullSet1, nullSet2))
        assertEquals(expectedNull, genericPlus(nullSet2, nullSet1))

        // mutable
        val mutableSet1 = mutableMultiSetOf(1, 2)
        val mutableSet2 = mutableMultiSetOf(2, 3, 4)
        val expectedMutable = multiSetOf(1, 2, 2, 3, 4)
        assertEquals(expectedMutable, genericPlus(mutableSet1, mutableSet2))
        assertEquals(expectedMutable, genericPlus(mutableSet2, mutableSet1))

        val otherMutable = TestMutableMultiSet(listOf(2, 3, 4))
        assertEquals(expectedMutable, genericPlus(mutableSet1, otherMutable))
        assertEquals(expectedMutable, genericPlus(otherMutable, mutableSet1))
    }
    ...
    fun testGenericMinus() {
        ...
        var intSet2 = emptyMultiSet<Int>()
        var expectedInt = emptyMultiSet<Int>()
        assertEquals(expectedInt, genericMinus(intSet1, intSet2))
        assertEquals(expectedInt, genericMinus(intSet2, intSet1))
        ...
        assertEquals(stringExpected, genericMinus(stringSet1, stringSet2))
        stringExpected = TestMultiSet(listOf("greetings", "planet", "farewell", "planet", "greetings", "farewell"))
        assertEquals(stringExpected, genericMinus(stringSet2, stringSet1))
        ...
        assertEquals(listExpected, genericMinus(listSet1, listSet2))
        listExpected = multiSetOf(emptyList())
        assertEquals(listExpected, genericMinus(listSet2, listSet1))

        val compListSet1: MultiSet<List<Comparable<*>>> = multiSetOf(listOf(1, 2, 3), listOf("abc", "def"), listOf("abc", "def"))
        val compListSet2: MultiSet<List<Comparable<*>>> = multiSetOf(listOf(1, 2, 3), listOf(1, 2, 3), emptyList())
        var compListExpected: MultiSet<List<Comparable<*>>> = multiSetOf(listOf("abc", "def"), listOf("abc", "def"))
        assertEquals(compListExpected, genericMinus(compListSet1, compListSet2))
        compListExpected = multiSetOf(listOf(1, 2, 3), emptyList())
        assertEquals(compListExpected, genericMinus(compListSet2, compListSet1))

        val nullSet1 = multiSetOf(1, 1, 2, null)
        var expectedNull: MultiSet<Int?> = multiSetOf(2)
        val nullSet2 = multiSetOf(1, 1, 5, 6, null, null)
        assertEquals(expectedNull, genericMinus(nullSet1, nullSet2))
        expectedNull = multiSetOf(5, 6, null)
        assertEquals(expectedNull, genericMinus(nullSet2, nullSet1))

        // mutable
        val mutableSet1 = mutableMultiSetOf(1, 2, 3, 3)
        val mutableSet2 = mutableMultiSetOf(2, 3, 4)
        val expectedMutable = multiSetOf(1, 3)
        assertEquals(expectedMutable, genericMinus(mutableSet1, mutableSet2))

        val otherMutable = TestMutableMultiSet(listOf(2, 3, 4))
        assertEquals(expectedMutable, genericMinus(mutableSet1, otherMutable))
    }
    ...
    fun testGenericIntersect() {
        ...
        var intSet2 = emptyMultiSet<Int>()
        var expectedInt = emptyMultiSet<Int>()
        assertEquals(expectedInt, genericIntersect(intSet1, intSet2))
        assertEquals(expectedInt, genericIntersect(intSet2, intSet1))
        ...
        assertEquals(expectedList, genericIntersect(listSet1, listSet2))
        assertEquals(expectedList, genericIntersect(listSet2, listSet1))
        ...
        assertEquals(expectedNull, genericIntersect(nullSet1, nullSet2))
        assertEquals(expectedNull, genericIntersect(nullSet2, nullSet1))

        // mutable
        val mutableSet1 = mutableMultiSetOf(1, 2, 3)
        val mutableSet2 = mutableMultiSetOf(2, 3, 4, 2)
        val expectedMutable = multiSetOf(2, 3)
        assertEquals(expectedMutable, genericIntersect(mutableSet1, mutableSet2))
        assertEquals(expectedMutable, genericIntersect(mutableSet2, mutableSet1))

        val otherMutable = TestMutableMultiSet(listOf(2, 3, 4, 2))
        assertEquals(expectedMutable, genericIntersect(mutableSet1, otherMutable))
        assertEquals(expectedMutable, genericIntersect(otherMutable, mutableSet1))
    }
}
